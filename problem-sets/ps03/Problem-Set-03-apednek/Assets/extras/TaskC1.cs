...
namespace PS03 {
    ...
    public class TaskC1 : MonoBehaviour
    {
        ...
        [SerializeField] public LineRenderer controlPolyLine;
        ...
        public void AddControlPoint() {
            ...
            if(currentPoint >= 3 && (currentPoint % 2) != 0) {
                ...
                //     isAlternate = true;
                //     splineNumber++;
                //     meshRenderer.materials[splineNumber] = material;
                // }
                // splineNumber++;
                // meshRenderer.materials[splineNumber] = new Material(Shader.Find(shaderName));
        ...
        void Awake() {
            ...
            for(int i=0; i< 15; i++){
                ...
                meshRenderer.materials[i] = new Material(Shader.Find(shaderName));
            }
            // material = meshRenderer.materials[splineNumber];
        ...
        void DrawSpline() {
            ...
            // meshRenderer.materials = new Material[15];
            // meshRenderer.materials[splineNumber] = new Material(Shader.Find(shaderName));
